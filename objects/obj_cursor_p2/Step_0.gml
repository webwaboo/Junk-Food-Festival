...
if (keyboard_check_pressed(ord("L"))) {
    ...
    if (count > 1) {
		// Récupérer le bloc externe (avant suppression)
		var bloc_to_move = line[0];
        
		// Retirer le bloc
        array_delete(line, 0, 1); // on prend le bloc "externe"

        // L'ajouter en tête
        array_insert(line, array_length(line), bloc_to_move);  // on l’envoie "vers le corps"
