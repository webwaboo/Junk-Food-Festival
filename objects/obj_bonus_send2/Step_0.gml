...
if (clash != noone && !clash.handled) {
    ...
    var _duration = 5 * game_get_speed(gamespeed_fps);
    if (clash.bloc_owner == "J1") global.send2_j1_timer = _duration;
    else if (clash.bloc_owner == "J2") global.send2_j2_timer = _duration;
